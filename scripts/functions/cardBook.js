import { changeReadStatus, deleteBook } from './functionalities.js'

export function renderBookCard (array, element, index) {
  ...
  const btnIsRead = document.createElement('span')
